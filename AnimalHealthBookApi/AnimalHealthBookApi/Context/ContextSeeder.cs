    ...
    public class ContextSeeder
    {
        ...
        public void Seed()
        {
            _context.Database.EnsureCreated();
                ...
                //CoatColor black = new CoatColor { Name = "Black" };
                //_context.CoatColors.Add(black);

                //CoatColor white = new CoatColor { Name = "White" };
                //_context.CoatColors.Add(white);

                //CoatColor brown = new CoatColor { Name = "Brown" };
                //_context.CoatColors.Add(brown);

                //CoatColor blackWhite = new CoatColor { Name = "Black-White" };
                //_context.CoatColors.Add(blackWhite);


                //CoatType shortHair = new CoatType { Name = "Short Hair" };
                //_context.CoatTypes.Add(shortHair);

                //CoatType longHair = new CoatType { Name = "Long Hair" };
                //_context.CoatTypes.Add(longHair);

                //CoatType curly = new CoatType { Name = "Curly" };
                //_context.CoatTypes.Add(curly);

                //CoatType straight = new CoatType { Name = "Straight" };
                //_context.CoatTypes.Add(straight);
